...
function AdminCards() {
	...
	return (
		<div className='space-y-3'>
			...
			<div className='grid grid-cols-4 gap-5'>
				<div
					className='text-center min-h-[100px] bg-[#fff] flex items-center justify-center border-y-2 !border-spacing-96  rounded-xl text-3xl text-[#325ecd] font-bold'>
					{t('Продажи')}:
				</div>
				...
				{new Array(3).fill('').map(() => {
					return (
						<div
							className='col-span-1 | text-[#6b8b48] bg-[#fff] font-bold !text-center !px-3 py2  border-y-2  rounded-xl shadow-md flex items-center justify-center text-2xl'>
							5ta /
							<br />
							125mln.sum
							<br />
