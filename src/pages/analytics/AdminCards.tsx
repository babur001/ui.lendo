	...
	return (
		<div className='space-y-3 bg-[#F6F6F7] rounded-lg px-2 py-2'>
			<div className='grid grid-cols-4 gap-5'>
				...
				{titles.map((title) => {
					return (
						<div className='col-span-1 | bg-[#fff] text-[#325ecd] flex items-center justify-center py-2 rounded-lg shadow-md text-2xl font-bold'>
							{title}:
						</div>
					);
				})}
			...
			<div className='grid grid-cols-4 gap-5'>
				<div className='text-center min-h-[100px] bg-[#fff] flex items-center justify-center shadow-md rounded-xl text-2xl text-[#9c4a09] font-bold'>
					{t('Продажи в рассрочку')}
				</div>

				{new Array(3).fill('').map(() => {
					return (
						<div className=' bg-[#fff]  !text-center !px-3 py2  shadow-md rounded-xl flex items-center justify-center gap-4 text-1xl'>
							<div>
								<div className='flex'>
			...
			<div className='grid grid-cols-4 gap-5'>
				<div className='text-center min-h-[100px] bg-[#fff] flex items-center justify-center shadow-md !border-spacing-96  rounded-xl text-2xl text-[#9c4a09] font-bold'>
					<div>
						{t('Лидер продаж')}
